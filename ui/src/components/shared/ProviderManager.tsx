...
const ACCENT = {
  pink: { ring: 'ring-pink-400', checkbox: 'text-pink-500 focus:ring-pink-500', border: 'border-pink-500/30' },
  amber: { ring: 'ring-amber-400', checkbox: 'text-amber-500 focus:ring-amber-500', border: 'border-amber-500/30' },
};
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2" onClick={(e) => e.stopPropagation()}>
                    ...
                    <input
                      ...
                      className={`w-4 h-4 rounded border-slate-600 bg-slate-700 ${colors.checkbox} focus:ring-offset-slate-800`}
                    />
                  </div>
                </div>
              </div>
